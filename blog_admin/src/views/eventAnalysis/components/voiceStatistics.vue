<template>
  ...
  <div>
    ...
    <div class="dashboard-editor-container">
      ...
      <el-tabs>
        <keep-alive>
          <self-total-bar width="100%" autoresize  />
        </keep-alive>
      </el-tabs>

      <el-tabs>
        <keep-alive>
          <video-total-bars width="100%" autoresize />
        </keep-alive>
      </el-tabs>
...
<script>
  import selfTotalBar from  './selfArticleTotalBar'
  import videoTotalBars from  './videoTotalAnalysisBar'
  export default {
    name: 'DashboardAdmin',
    components: {
      selfTotalBar,
