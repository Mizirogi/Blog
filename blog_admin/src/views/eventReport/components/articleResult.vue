  ...
  <div class="app-container">
    <div class="filter-container">
      <el-row type="flex" align="middle">
        ...
        <span style="font-size:16px;margin-left:auto;">共{{ total }}条，其中负面</span><span style="color:red;font-size:16px;font-weight:700;">1</span><span style="font-size:16px;margin-right:30px;">条</span>
      </el-row>
